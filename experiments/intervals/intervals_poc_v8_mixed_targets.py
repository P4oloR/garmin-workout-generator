...
WORKOUT_NAME = "GWG PoC 8 - Mixed Pace HR"
EXTERNAL_ID_PREFIX = "garmin-workout-generator-poc8"
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="PoC 8: distanza con target misti Pace range e Z1 HR via Intervals.icu -> Garmin."
    )
    parser.add_argument(
        "--date",
        required=True,
    ...
    print("Workout PoC 8 creato/aggiornato con successo.")
