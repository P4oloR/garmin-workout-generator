...
WORKOUT_NAME = "GWG PoC 5 - Pace target"
EXTERNAL_ID_PREFIX = "garmin-workout-generator-poc5"
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="PoC 5: target passo assoluto via Intervals.icu -> Garmin."
    )
    parser.add_argument(
        "--date",
        required=True,
    ...
    print("Workout PoC 5 creato/aggiornato con successo.")
